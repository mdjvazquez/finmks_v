...
export const Reports: React.FC = () => {
  ...
  const renderTransactionList = (
    ...
    <div className="mt-6 mb-4 break-inside-avoid">
      <h5 className="font-bold text-gray-800 text-xs uppercase tracking-wider mb-2 border-b border-gray-300 pb-1">
        {title}
      </h5>
        ...
        <tbody>
          {transactions.map((tx, i) => (
            <tr key={i} className="border-b border-gray-100">
              ...
              {showDueDate && (
                <td className="py-1 text-red-600">{tx.dueDate}</td>
              )}
    ...
    if (report.type === ReportType.INCOME_STATEMENT) {
      ...
      return (
        <div className="space-y-4 font-mono text-sm text-black">
          <div>
            <h4 className="font-bold text-gray-900 border-b border-gray-400 mb-2">
              {t("r_revenues")}
            </h4>
          ...
          <div>
            <h4 className="font-bold text-gray-900 border-b border-gray-400 mb-2 mt-6">
              {t("r_expenses")}
            </h4>
            <div className="flex justify-between font-bold pt-2 border-t border-gray-200 mt-2 bg-gray-50 p-2">
        ...
        <div className="space-y-6 font-mono text-sm text-black">
          <div>
            ...
            <div className="flex justify-between py-1">
              <span>{t("r_cash_equivalents")}</span>
              <span>${assets.cashAndEquivalents.toFixed(2)}</span>
            </div>
            <div className="flex justify-between py-1">
              <span>{t("r_accounts_receivable")}</span>
              <span>${assets.accountsReceivable.toFixed(2)}</span>
            </div>
            <div className="flex justify-between py-1">
              <span>{t("r_fixed_assets")}</span>
              <span>${assets.fixedAssets.toFixed(2)}</span>
            </div>
            <div className="flex justify-between font-bold pt-2 border-t border-gray-200 mt-2 bg-gray-50 p-2">
          ...
          <div>
            ...
            <div className="flex justify-between py-1">
              <span>{t("r_accounts_payable")}</span>
              <span>${liabilities.accountsPayable.toFixed(2)}</span>
            </div>
            <div className="flex justify-between py-1">
              <span>{t("r_long_term_debt")}</span>
              <span>${liabilities.longTermDebt.toFixed(2)}</span>
            </div>
            <div className="flex justify-between font-bold pt-2 border-t border-gray-200 mt-2 bg-gray-50 p-2">
          ...
          <div className="mt-10 pt-4 border-t border-dashed border-gray-300">
            ...
            {renderTransactionList(
              t("r_accounts_receivable"),
              details?.pendingReceivables || [],
              true
            )}
            {renderTransactionList(
              t("r_accounts_payable"),
              details?.pendingPayables || [],
              true
            )}
          </div>
        </div>
      ...
      return (
        <div className="space-y-4 font-mono text-sm text-black">
          <div className="flex justify-between py-2 border-b border-gray-200">
            ...
            <span
              className={
                operatingActivities >= 0 ? "text-green-700" : "text-red-700"
              }
            >
              ${operatingActivities.toFixed(2)}
            </span>
          </div>
          <div className="flex justify-between py-2 border-b border-gray-200">
            ...
            <span
              className={
                investingActivities >= 0 ? "text-green-700" : "text-red-700"
              }
            >
              ${investingActivities.toFixed(2)}
            </span>
          </div>
          <div className="flex justify-between py-2 border-b border-gray-200">
            ...
            <span
              className={
                financingActivities >= 0 ? "text-green-700" : "text-red-700"
              }
            >
              ${financingActivities.toFixed(2)}
            </span>
          </div>
          <div className="flex justify-between font-bold text-lg pt-4 mt-4 bg-gray-50 p-2">
            <span>{t("r_net_cash_flow")}</span>
            <span
              className={netCashFlow >= 0 ? "text-green-700" : "text-red-700"}
            >
          ...
          {flowByRegister && (
            <div className="mt-8 pt-4 border-t border-gray-300">
              ...
              <table className="w-full text-xs font-mono">
                ...
                <tbody>
                  {flowByRegister.map((reg: any, i: number) => (
                    <tr key={i} className="border-b">
                      <td className="p-2 font-medium text-black">{reg.name}</td>
                      <td className="p-2 text-right text-green-600">
                        +${reg.incomes.toFixed(2)}
                      </td>
                      <td className="p-2 text-right text-red-600">
                        -${reg.expenses.toFixed(2)}
                      </td>
                      <td className="p-2 text-right">
                        {reg.transfersIn > 0 && (
                          <span className="text-green-600 block">
                            +{reg.transfersIn.toFixed(2)}
                          </span>
                        )}
                        {reg.transfersOut > 0 && (
                          <span className="text-red-600 block">
                            -{reg.transfersOut.toFixed(2)}
                          </span>
                        )}
                      </td>
                      <td
                        className={`p-2 text-right font-bold ${
                          reg.netChange >= 0 ? "text-black" : "text-red-700"
                        }`}
                      >
                        ${reg.netChange.toFixed(2)}
                      </td>
                    </tr>
                  ))}
                </tbody>
          ...
          <div className="mt-10 pt-4 border-t border-dashed border-gray-300">
            ...
            {renderTransactionList(
              t("r_op_activities"),
              details?.operatingTransactions || []
            )}
            {renderTransactionList(
              t("r_inv_activities"),
              details?.investingTransactions || []
            )}
            {renderTransactionList(
              t("r_fin_activities"),
              details?.financingTransactions || []
            )}
          </div>
        </div>
      );
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setGenerationRange((p) => ({ ...p, end: e.target.value }))
                    }
                    className="w-full text-sm p-2 border rounded-lg outline-none bg-white text-black focus:ring-2 focus:ring-blue-100"
                  />
                </div>
          ...
          <div className="max-h-64 overflow-y-auto">
            <table className="w-full text-sm">
              <thead className="bg-white text-gray-500 uppercase text-xs sticky top-0 z-10">
                <tr>
                  <th className="px-6 py-3 text-left bg-gray-50 whitespace-nowrap">
                    {t("folio")}
                  </th>
                  <th className="px-6 py-3 text-left bg-gray-50 whitespace-nowrap">
                    {t("type")}
                  ...
                  <th className="px-6 py-3 text-right bg-gray-50 whitespace-nowrap">
                    {t("generationDate")}
                  </th>
                  <th className="px-6 py-3 text-center bg-gray-50 whitespace-nowrap">
                    {t("action")}
                  </th>
                </tr>
              </thead>
                ...
                {reports.map((r) => (
                  <tr
                    ...
                    className={`hover:bg-blue-50 transition-colors ${
                      selectedReport?.folio === r.folio ? "bg-blue-50" : ""
                    }`}
                  >
          ...
          {selectedReport && (
            <div className="max-w-4xl mx-auto">
              ...
              <div id="report-content" className="bg-white p-8 text-black">
                ...
                <div className="flex items-start justify-between mb-8 border-b-2 border-black pb-6">
                  <div className="flex items-center gap-4">
                    {selectedReport.companySnapshot.logoUrl && (
                      <img
                        src={selectedReport.companySnapshot.logoUrl}
                        alt="Logo"
                    ...
                    <div>
                      <h1 className="text-xl font-bold uppercase tracking-wider text-black">
                        {selectedReport.companySnapshot.name}
                      </h1>
                      <p className="text-xs text-gray-600">
                        {selectedReport.companySnapshot.address}
                      </p>
                      <p className="text-xs text-gray-600">
                        Tax ID: {selectedReport.companySnapshot.taxId}
                      </p>
                    </div>
                  </div>
                  <div className="text-right text-black">
                    ...
                    <p className="text-sm">
                      {t("period")}: {selectedReport.periodStart} -{" "}
                ...
                {/* Data Table */}
                <div className="mb-10">
                  <h3 className="text-lg font-bold text-gray-900 mb-4 uppercase tracking-wide border-b border-gray-400 pb-1">
                    {t("statementDetails")}
                  </h3>
                ...
                <div className="mb-8 break-inside-avoid">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    {selectedReport.ratios.map((ratio, idx) => (
                      <div
                        key={idx}
                        className="p-3 bg-gray-50 rounded-lg border border-gray-200 break-inside-avoid"
                      >
                ...
                {selectedReport.aiAnalysis ? (
                  ...
                  <div className="p-4 text-center text-gray-400 border border-dashed border-gray-300 rounded-lg mb-8 text-sm no-print">
                    AI Analysis not generated yet. Click "Analyze with Gemini
                    AI" to generate insights.
                  </div>
                )}
                ...
                <div className="mt-12 pt-8 border-t border-gray-300 flex justify-between items-end text-xs text-gray-600">
                  <div>
                    <p>
                      {t("generatedBy")}: {selectedReport.generatedBy}
                    </p>
                    <p>
                      {t("generationDate")}:{" "}
                      {new Date(selectedReport.dateGenerated).toLocaleString()}
                    </p>
                  </div>
