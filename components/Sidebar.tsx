...
import { LayoutDashboard, Receipt, FileText, LogOut, PieChart, Settings, Bell } from 'lucide-react';
    ...
    <div className="w-64 bg-gray-800 text-white flex flex-col h-full md:h-screen md:sticky md:top-0 no-print shadow-xl">
      ...
      <div className="p-4 border-t border-slate-700 bg-slate-900">
        <div className="flex items-center gap-3 mb-4 px-2">
            <img src={currentUser?.avatar} alt="User" className="w-8 h-8 rounded-full bg-slate-800" />
