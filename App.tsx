...
const AppContent: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 text-gray-900 font-sans">
      ...
      <div className={`fixed inset-y-0 left-0 z-50 transform ${sidebarOpen ? "translate-x-0" : "-translate-x-full"} md:translate-x-0 transition-transform duration-200 ease-in-out md:static`}>
         <Sidebar currentPage={currentPage} setPage={(page) => { setCurrentPage(page); setSidebarOpen(false); }} />
      </div>
